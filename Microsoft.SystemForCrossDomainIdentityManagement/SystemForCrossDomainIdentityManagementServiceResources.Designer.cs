...
namespace Microsoft.SCIM {
    ...
    public class SystemForCrossDomainIdentityManagementServiceResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The resource identifier is specified in both the URI and request body with different values..
        /// </summary>
        public static string ExceptionIdentifierInUriAndBodyAreNotEqual {
            get {
                return ResourceManager.GetString("ExceptionIdentifierInUriAndBodyAreNotEqual", resourceCulture);
            }
        }
